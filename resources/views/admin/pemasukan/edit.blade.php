   ...
   <div class="pd-20 card-box mb-30">
      ...
      <form action="/admin/pemasukan/update/{{$pemasukan->id}}" method="POST" enctype="multipart/form-data">
         ...
         <div class="form-group">
            ...
            <input type="date" autofocus name="tanggal" required class="form-control" value="{{$pemasukan->tanggal}}">
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            ...
            <input type="number" name="total" required class="form-control" value="{{$pemasukan->total}}" placeholder="Masukkan Total .....">     
         </div>
